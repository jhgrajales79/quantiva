// Sector GICS de cada constituyente del S&P 500, capturado el 2026-08-18
// desde https://github.com/datasets/s-and-p-500-companies junto con
// SP500_CONSTITUENTS (mismo snapshot). Símbolos ya normalizados al formato
// de Yahoo Finance ("." -> "-").
...
export const SECTOR_LIST: string[] = ["Communication Services","Consumer Discretionary","Consumer Staples","Energy","Financials","Health Care","Industrials","Information Technology","Materials","Real Estate","Utilities"];
