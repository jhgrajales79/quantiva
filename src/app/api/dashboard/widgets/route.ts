...
import { DEFAULT_DASHBOARD_WIDGETS, sanitizeWidgetList, sanitizeDashboardWidgetLayout } from "@/lib/dashboard-widgets";
...
export async function PUT(request: Request) {
  ...
  const layout = sanitizeDashboardWidgetLayout(body?.layout);
